...
<div class="container">
    <div class="row" style="margin-top:10vh">
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="panel panel-default" style="width:auto;opacity: 1;">
                <div class="panel-heading" style="text-align: center;background-color:#286090;color:#fff">         
                    <img class="card-img-top" src="{{asset('assets_home/img/logo.png')}}" class="img-responsive" style="width:15%"/>
